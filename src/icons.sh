...
for pic in $path/noaadoppler_active.svg $path/noaadoppler_inactive.svg
do
  echo "converting $pic"
...
$path/../include/opencpn/bitmaps/png2wx.pl -C $path/icons.cpp -H $path/icons.h -M ICONS_H $path/*.png
